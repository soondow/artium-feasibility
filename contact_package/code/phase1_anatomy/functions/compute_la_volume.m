...
% 함수 설명:
%   NIfTI 라벨 배열의 좌심방 전경 복셀 수와 복셀 간격으로 부피를 계산합니다.
%
% 입력:
%   lab (수치형 배열, 비어 있을 수 없음: 좌심방 라벨 배열입니다. 0보다 큰 값은 전경으로 처리합니다.)
%   infoLab (구조체, 비어 있을 수 없음: PixelDimensions 필드를 포함하는 영상 메타데이터입니다.)
%
% 출력:
...
%   3. 세제곱밀리미터 값을 1000으로 나누어 mL로 변환합니다.
    ...
    spacing = infoLab.PixelDimensions;
