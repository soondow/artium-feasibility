clear; clc;
% This model is an executable monitoring-policy illustration, not a full
% replacement for the MATLAB reference pipeline. It keeps the core
% observer-controller logic visible with numeric step inputs.
...
% The script recreates the model from scratch so the generated .slx and PNG
% always reflect the current block layout and policy gates.
...
% This is the closed-loop sanity check for the low-quality direct-alert gate.
