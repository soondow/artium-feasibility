...
%SCORE_MSPC_MODEL Score HRV windows using T2 and Q residual statistics.
    ...
    % Incomplete feature rows are left as NaN so missingness does not become a
    % fabricated MSPC anomaly score.
    ...
    % Max(T2, Q) flags either score-space deviation or residual structure, but
    % it remains an observation candidate for the downstream controller.
