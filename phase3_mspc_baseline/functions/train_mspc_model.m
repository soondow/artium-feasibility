...
%
% The model is trained only on high-quality normal windows so T2 and Q
% residuals represent departure from a stable monitoring baseline.
    ...
    % A compact PCA subspace is sufficient for a feasibility baseline and
    % avoids presenting MSPC as a fully calibrated clinical classifier.
    ...
    model.latent = latent;
    model.numPC = numPC;
    % Empirical 95% limits define a normal-operation reference, not a clinical
